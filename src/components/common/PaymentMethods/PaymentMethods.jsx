        ...
        <div className={s.paymentsContainer}>
            <PaymentMethod
                logo={<svg width="24" height="29" viewBox="0 0 24 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="sbp-1669939801-logotic-brand 1" clipPath="url(#clip0_1617_14900)">
            ...
            <PaymentMethod
                logo={<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Frame">
                        <path id="Vector" fillRule="evenodd" clipRule="evenodd" d="M4 4.75C2.48122 4.75 1.25 5.98122 1.25 7.5V17.5C1.25 19.0188 2.48122 20.25 4 20.25H20C21.5188 20.25 22.75 19.0188 22.75 17.5V10.25H6C5.58579 10.25 5.25 9.91421 5.25 9.5C5.25 9.08579 5.58579 8.75 6 8.75H22.75V7.5C22.75 5.98122 21.5188 4.75 20 4.75H4Z" fill="#F9F8FC" />
                    </g>
                </svg>
                }
