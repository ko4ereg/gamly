...
const PopupReplenishmentFailure = ({ popupActive, setPopupActive }) => {
    ...
    return (
        <PopupWithImage image={failback} back={'failure'} popupActive={popupActive} setPopupActive={setPopupActive} heading={"Ошибка во время пополнения"} note={'Произошла ошибка во время пополнения. Попробуйте другой способ оплаты или обратитесь к нашей службе поддержки по кнопкам ниже'}>
