...
const PopupFiltersLayout = ({ popupActive, setPopupActive, note }) => {
    ...
    return (
        <PopupWithoutImage bottom={<BottomMenu separator={true}><ButtonPrimary text={'Перейти к оплате'} /><ButtonSecondary disabled={disabled} onClick={handleReset} text={'Сбросить'} /></BottomMenu>} popupActive={popupActive} setPopupActive={setPopupActive} note={note} heading={"Пополнение steam"}>
