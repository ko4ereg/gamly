...
const PopupReplenishmentSucces = ({ popupActive, setPopupActive }) => {
    return (
        ...
        <PopupWithImage popupActive={popupActive} setPopupActive={setPopupActive} heading={"Пополнение прошло успешно"} note={'Вы пополнили свой счет на 1000 gamly coin, и можете начать их тратить уже сейчас!'}>
