    ...
    return (
        <div className={s.container}>
            <div className={s.text}>
                <div className={s.title}>Читайте нас</div>
                <div className={s.subtitle}>Мы хотели чтобы геймеры в России могли покупать игры, все для компьютеров, пополнять Steam и т.д. внутри одной экосистемы, и кажется... у нас это получилось</div>
            </div>
            <div className={s.buttons}>
                <SocialMediaButton link={'https://www.google.com'}
