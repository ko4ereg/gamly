            ...
            <div className={s.container}>
                ...
                <div className={s.menu}>
                    ...
                    <div className={s.menu_buttons}>
                        <div className={s.menu_button}  ><MenuButton small={window.innerWidth < 1439 ? true : false} text={'Пополнение Steam'} /> </div>
                        <div className={s.menu_button}  ><MenuButton small={window.innerWidth < 1439 ? true : false} text={'Магазин'} /> </div>
                        <div className={s.menu_button}  ><MenuButton small={window.innerWidth < 1439 ? true : false} text={'Внутриигровые предметы'} /> </div>
                        <div className={s.menu_button}  ><MenuButton small={window.innerWidth < 1439 ? true : false} text={'Гарант'} /> </div>
                    </div>
                </div>
